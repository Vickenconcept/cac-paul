      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="rounded-2xl overflow-hidden w-80 shadow-2xl"
            style={{
              background: "#FFFFFF",
          ...
          >
            ...
            <div className="p-4">
              <a
                href={`https://wa.me/${WHATSAPP}?text=Hello%20Paul%20%26%20Associates%2C%20I%20need%20help%20with%20my%20business%20registration.`}
                target="_blank"
